...
public final class OpenObserveHttpExporterBuilder<T extends Marshaler> {
    public static final long DEFAULT_TIMEOUT_SECS = 10;
    public static final long DEFAULT_CONNECT_TIMEOUT_SECS = 10;

    private static final Logger LOGGER = Logger.getLogger(OpenObserveHttpExporterBuilder.class.getName());
    ...
    public OpenObserveHttpExporterBuilder(String exporterName, String type, String defaultEndpoint) {
    ...
    public OpenObserveHttpExporterBuilder<T> setTimeout(long timeout, TimeUnit unit) {
        timeoutNanos = unit.toNanos(timeout);
        return this;
    }

    public OpenObserveHttpExporterBuilder<T> setConnectTimeout(long timeout, TimeUnit unit) {
        connectTimeoutNanos = unit.toNanos(timeout);
        return this;
    }

    public OpenObserveHttpExporterBuilder<T> setEndpoint(String endpoint) {
        URI uri = ExporterBuilderUtil.validateEndpoint(endpoint);
        this.endpoint = uri.toString();
        return this;
    }

    public OpenObserveHttpExporterBuilder<T> setCompression(String compressionMethod) {
        this.compressionEnabled = compressionMethod.equals("gzip");
        return this;
    }

    public OpenObserveHttpExporterBuilder<T> addConstantHeaders(String key, String value) {
        constantHeaders.put(key, value);
        return this;
    }

    public OpenObserveHttpExporterBuilder<T> setHeadersSupplier(Supplier<Map<String, String>> headerSupplier) {
        this.headerSupplier = headerSupplier;
        return this;
    }

    public OpenObserveHttpExporterBuilder<T> setAuthenticator(Authenticator authenticator) {
        this.authenticator = authenticator;
        return this;
    }

    public OpenObserveHttpExporterBuilder<T> setTrustManagerFromCerts(byte[] trustedCertificatesPem) {
        tlsConfigHelper.setTrustManagerFromCerts(trustedCertificatesPem);
        return this;
    }

    public OpenObserveHttpExporterBuilder<T> setKeyManagerFromCerts(
            byte[] privateKeyPem, byte[] certificatePem) {
        tlsConfigHelper.setKeyManagerFromCerts(privateKeyPem, certificatePem);
        return this;
    }

    public OpenObserveHttpExporterBuilder<T> setSslContext(
            SSLContext sslContext, X509TrustManager trustManager) {
        tlsConfigHelper.setSslContext(sslContext, trustManager);
        return this;
    }

    public OpenObserveHttpExporterBuilder<T> setMeterProvider(Supplier<MeterProvider> meterProviderSupplier) {
        this.meterProviderSupplier = meterProviderSupplier;
        return this;
    }

    public OpenObserveHttpExporterBuilder<T> setRetryPolicy(RetryPolicy retryPolicy) {
        this.retryPolicy = retryPolicy;
        return this;
    }

    public OpenObserveHttpExporterBuilder<T> exportAsJson() {
        this.exportAsJson = true;
        return this;
    }

    @SuppressWarnings("BuilderReturnThis")
    public OpenObserveHttpExporterBuilder<T> copy() {
        OpenObserveHttpExporterBuilder<T> copy = new OpenObserveHttpExporterBuilder<>(exporterName, type, endpoint);
    ...
    public OpenObverseHttpExporter<T> build() {
        ...
        return new OpenObverseHttpExporter<>(exporterName, type, httpSender, meterProviderSupplier, exportAsJson);
    }
    ...
    private static HttpSenderProvider resolveHttpSenderProvider() {
        ...
        for (HttpSenderProvider spi :
                ServiceLoader.load(HttpSenderProvider.class, OpenObserveHttpExporterBuilder.class.getClassLoader())) {
