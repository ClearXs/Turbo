...
public interface Subscriber<D> extends ApplicationListener<ApplicationReadyEvent> {
     ...
     */
    default <T> Observable<D> subscribeOn(MethodConsumer<T> eventMethod) {
     ...
     * @see #subscribeOn(String)
     */
    default <T> Observable<D> subscribeOn(MethodSupplier<T> eventMethod) {
        String eventName = eventMethod.getMethodName();
        return subscribeOn(eventName);
    }
     ...
     * @see #subscribeOn(String)
     */
    default <T, R> Observable<D> subscribeOn(MethodFunction<T, R> eventMethod) {
        String eventName = eventMethod.getMethodName();
        return subscribeOn(eventName);
    }
     ...
     * @see #subscribeOn(String)
     */
    default <T1, T2> Observable<D> subscribeOn(MethodBiConsumer<T1, T2> eventMethod) {
        String eventName = eventMethod.getMethodName();
        return subscribeOn(eventName);
    }
     ...
     * @see #subscribeOn(String)
     */
    default <T1, T2, R> Observable<D> subscribeOn(MethodBiFunction<T1, T2, R> eventMethod) {
        String eventName = eventMethod.getMethodName();
        return subscribeOn(eventName);
    }
     ...
     * @see #subscribeOn(String)
     */
    default <T1, T2, T3> Observable<D> subscribeOn(MethodTerConsumer<T1, T2, T3> eventMethod) {
        String eventName = eventMethod.getMethodName();
        return subscribeOn(eventName);
    }
     ...
     * @see #subscribeOn(String)
     */
    default <T1, T2, T3, R> Observable<D> subscribeOn(MethodTerFunction<T1, T2, T3, R> eventMethod) {
        String eventName = eventMethod.getMethodName();
        return subscribeOn(eventName);
    }
     ...
     * @see #subscribeOn(String)
     */
    default <T1, T2, T3, T4> Observable<D> subscribeOn(MethodQueConsumer<T1, T2, T3, T4> eventMethod) {
        String eventName = eventMethod.getMethodName();
        return subscribeOn(eventName);
    }
     ...
     * @see #subscribeOn(String)
     */
    default <T1, T2, T3, T4, R> Observable<D> subscribeOn(MethodQueFunction<T1, T2, T3, T4, R> eventMethod) {
        String eventName = eventMethod.getMethodName();
        return subscribeOn(eventName);
    }
     ...
     * <p>为什么会存在Proxy方法，因为在Subscriber内部无法使用{@link #subscribeOn(MethodConsumer)}等方法，
     * * 原因是其实现是通过Cglib代理进行实现，故其内部并不是代理类实例，所以无法使用相对的增强。所以通过该方式，在实现类进行实现</p>
     *
