 ...
 * @since 0.1.0
 */
public class BehaviorSubscription<D> implements Subscription<D> {
    ...
    public BehaviorSubscription(Subscriber<D> subscriber, TopicKey eventBehavior, Method behavior, DomainEventContext eventContext) {
