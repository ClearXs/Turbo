...
public class BehaviorAdvisor extends TurboAdvisor {
    ...
    public BehaviorAdvisor(EventBus<DomainEventContext> domainEventBus) {
        super();
    ...
    public static class BehaviorAdvisorBuilder extends TurboAdvisorBuilder<BehaviorAdvisor> {
         ...
         */
        public static TurboAdvisorBuilder<BehaviorAdvisor> builder(EventBus<DomainEventContext> domainEventBus) {
