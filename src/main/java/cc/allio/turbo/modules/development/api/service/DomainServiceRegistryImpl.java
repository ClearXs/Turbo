...
public final class DomainServiceRegistryImpl implements DomainServiceRegistry, SmartLifecycle, ApplicationContextAware {
    ...
    private final EventBus<DomainEventContext> domainEventBus;
    private Disposable disposable;

    public static DomainServiceRegistry INSTANCE;

    public DomainServiceRegistryImpl(IDevBoService devBoService,
     ...
     * <ul>
     *     <li>{@link cc.allio.turbo.modules.development.entity.DomainEntityTableResolver}的表名解析</li>
     *     <li>{@link cc.allio.turbo.modules.development.entity.DomainEntityColumnDefListResolver}的列名解析</li>
     * </ul>
     *
